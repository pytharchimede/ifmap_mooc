...
final class AuthNotificationService
{
    ...
    public function resetChannels(): array { $raw=$this->settings->get('password_reset_channels','email,sms,whatsapp');return array_values(array_intersect(['email','sms','whatsapp'],array_filter(array_map('trim',explode(',',$raw))))); }
